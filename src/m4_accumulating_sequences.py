...
def run_test_make_less_simple_string():
    ...
    # Test 3:
    expected = '250'
    actual = make_less_simple_string(250, 250)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range (len(circles)):
        ...
        x = center.x
        y = center.y
        cor1 = rg.Point(x-radius, y-radius)
        cor2 = rg.Point(x+radius, y+radius)
        rect.append(rg.Rectangle(cor1, cor2))
    return rect
